...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{\webcommon/Web_Elgg_Setup}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\input{\webcommon/Web_DNS_Setup}
\input{\webcommon/Web_Apache_Setup}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
have different CSP setup. Details of the setup 
will be explained later.


\paragraph{Changing the configuration file.}
In the experiment, you need to modify the Apache 
...
the IP address of our server container (\texttt{10.9.0.5}). 
...
Apache will add the specified CSP header to all the 
...
\item Describe and explain your observations when you visit the above three websites.

\item Click the button of in the web pages from all the three websites, describe and 
...
Areas 1, 2, 4, 5, and 6 all display \texttt{OK}. Please include your 
modified configuration in the lab report.

\item Please explain why would CSP help prevent Cross-Site Scripting attacks. 
