...
the container as the user machine. 
...
the corresponding network interface, because we 
need to use it in our program. 
...
find out the network ID ourselves: 
...
(*@\textbf{c93733e9f913}@*)        seed_net            bridge              local
\end{lstlisting}
