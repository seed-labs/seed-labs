...
emu.addBinding(Binding('net-server',   filter=Filter(asn=152), action=Action.FIRST))
emu.addBinding(Binding('edu-server',   filter=Filter(asn=153), action=Action.FIRST))
