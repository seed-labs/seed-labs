...
This lab does not work on the Apple silicon machines (M1/M2 chips) yet,
because the shellcode used in the attack is x86 based. Efforts are being 
made to support the Apple machines. Meanwhile, students with such
Apple machines should do that using a cloud machine. 
